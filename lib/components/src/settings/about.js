...
Version.propTypes = {
  ...
  notLatest: PropTypes.bool.isRequired,
};

const UpgradeNotice = ({ alt, level, current, next, tag }) => (
    ...
    <UpgradeNotice.Intro>
      <Spaced>
        ...
        <div>
          ...
          Upgrade from {current} to the highest {level} ({tag}
          ): {next}
        </div>
      </Spaced>
    </UpgradeNotice.Intro>
...
UpgradeNotice.propTypes = {
  alt: PropTypes.bool,
  level: PropTypes.oneOf(['patch', 'minor', 'major', 'prerelease']).isRequired,
  current: PropTypes.string.isRequired,
  next: PropTypes.string.isRequired,
  tag: PropTypes.string.isRequired,
};
UpgradeNotice.defaultProps = {
  alt: false,
};
...
NonLatestNotice.propTypes = {
  tag: PropTypes.string.isRequired,
};

const AboutPage = ({ version = '', tag = 'latest', releases = [] } = {}) => {
